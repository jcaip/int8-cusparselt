...
int main(void) {
    ...
    CHECK_CUSPARSE( cusparseLtSpMMAPrune2(&handle,
                                          &matA,
                                          true,
                                          opA,
                                          dA, 
    ...
    CHECK_CUSPARSE( cusparseLtSpMMAPruneCheck2(&handle, &matA, true, opA, dA,
                                              d_valid, stream) )
    int is_valid;
    ...
    CHECK_CUSPARSE( cusparseLtSpMMACompressedSize2(&handle, &matA,
                                                  &compressed_size,
    ...
    CHECK_CUSPARSE( cusparseLtSpMMACompress2(&handle, &matA, true, opA, dA, dA_compressed,
